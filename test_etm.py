...
parser.add_argument('--documents', type=str, default='Data/clean_docs_2.csv', help='path to cleaned documents')
parser.add_argument('--embeddings', type=str, default='Models/embedding_2.wordvectors', help='path to word vectors (trained embeddings)')
...
parser.add_argument('--n_start', type=int, default=110, help='min number of topics to be trained')
parser.add_argument('--n_limit', type=int, default=150, help='max number of topics to be trained')
parser.add_argument('--n_step', type=int, default=5, help='step for number of topics')
parser.add_argument('--topn', type=int, default=15, help='the number of top words to be extracted from each topic')

args = parser.parse_args()

date = gmtime()
sys.stdout = open(f"ETM_test_log_{strftime('%d%m%y', date)}.txt", "w")
