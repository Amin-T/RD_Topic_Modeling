...
parser.add_argument('--save_model', type=str, default='Models/T2V_model', help='directory to save tranied LDA model')
...
top2vec_model.save(f"{args.save_model}_{strftime('%d%m%y', date)}")
